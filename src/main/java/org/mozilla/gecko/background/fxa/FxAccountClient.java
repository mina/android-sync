...
public class FxAccountClient {
  ...
  public void createAccount(final CreateDelegate createDelegate, final RequestDelegate<String> delegate) {
  ...
  public void login(final AuthDelegate authDelegate, final RequestDelegate<byte[]> delegate) {
